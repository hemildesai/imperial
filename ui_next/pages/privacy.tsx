...
const Privacy: NextPage = () => {
    return (
        <>
            <Header />
            <main className="overflow-auto h-[85vh] w-full md:w-3/4 m-auto my-5 py-5 px-10 bg-black bg-opacity-50 text-white rounded-xl backdrop-blur">
                <h1 className="text-3xl mb-3">Privacy Policy</h1>
                <p className="my-1">Last updated: March 08, 2022</p>
                <p className="my-1">
                ...
                <h2 className="text-xl mb-2">Interpretation</h2>
                <p className="my-1">
                ...
                <h2 className="text-xl mb-2">Definitions</h2>
                ...
                <ul className="list-disc">
                    ...
                    <li>
                        <p className="my-1">
                            <strong>Website</strong> refers to Imperials!,
                            accessible from{" "}
                            <a
                                href="https://imperials.app"
                ...
                <h2 className="text-xl mb-2">Types of Data Collected</h2>
                <h3>Personal Data</h3>
                <p className="my-1">
                ...
                <h2 className="text-xl mb-2">Use of Your Personal Data</h2>
                <p className="my-1">
                ...
                <h2 className="text-xl mb-2">Transfer of Your Personal Data</h2>
                <p className="my-1">
                ...
                <h2 className="text-xl mb-2">Security of Your Personal Data</h2>
                <p className="my-1">
                ...
                <h1 className="text-3xl mb-3">Children's Privacy</h1>
                <p className="my-1">
                ...
                <h1 className="text-3xl mb-3">Links to Other Websites</h1>
                <p className="my-1">
                ...
                <ul className="list-disc">
                    <li>
                        ...
                        <a
                            href="https://imperials.app/contact"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://imperials.app/contact
                        </a>
                    </li>
                </ul>
            </main>
